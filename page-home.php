...
<div class="fullwidthbanner" data-height="600" data-shadow="0" data-navigationStyle="preview2">
    <ul class="hide">
        ...
        <li data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-delay="10000" data-saveperformance="off" data-title="Slide 1" style="background-color: #F6F6F6;">
            ...
            <img src=<?php echo get_template_directory_uri() . "/assets/images/_smarty/backgrounds/grey-noise-min.jpg" ?> alt="video" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat">
            ...
            <div class="tp-caption customin ltl tp-resizeme revo-slider-caps-text uppercase"
                ...
                <img src=<?php echo get_template_directory_uri() . "/assets/demo_files/images/desktop_slider_2.png" ?> alt="">
            </div>
